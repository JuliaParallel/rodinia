...
void ecc(fp timeinst, fp *initvalu, int initvalu_offset, fp *parameter,
    ...
    // decoded input initial data			// GET VARIABLES FROM MEMORY AND SAVE
    // LOCALLY !!!!!!!!!!!!!!!!!!
    fp initvalu_1;
    fp initvalu_2;
    fp initvalu_3;
    ...
    I_nak_sl = Fsl * IbarNaK * fnak * Ko /
               (1 + pow((KmNaip / initvalu_33), 4)) / (Ko + KmKo);
    ...
    tauxr =
        1 /
        (0.00138 * (initvalu_39 + 7) / (1 - exp(-0.123 * (initvalu_39 + 7))) +
    ...
    eks = (1 / FoRT) *
          log((Ko + pNaK * Nao) / (initvalu_35 + pNaK * initvalu_34));
    ...
    I_Ca_junc = (Fjunc_CaL * ibarca_j * initvalu_4 * initvalu_5 *
                ...
                0.45;
    I_Ca_sl = (Fsl_CaL * ibarca_sl * initvalu_4 * initvalu_5 *
    ...
    finavalu[offset_29] =
        kon_slh * initvalu_37 * (Bmax_SLhighsl - initvalu_29) -
