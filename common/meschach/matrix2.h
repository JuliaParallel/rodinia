...
extern MAT *BKPfactor(), *CHfactor(), *LUfactor(), *QRfactor(), *QRCPfactor(),
    *LDLfactor(), *Hfactor(), *MCHfactor(), *m_inverse();
...
extern VEC *BKPsolve(), *CHsolve(), *LUsolve(), *_Qsolve(), *QRsolve(),
    *LDLsolve(), *Usolve(), *Lsolve(), *Dsolve(), *LTsolve(), *UTsolve(),
    *LUTsolve(), *QRCPsolve();
...
extern VEC *BKPsolve(const MAT *A, PERM *pivot, const PERM *blocks,
    ...
    *QRCPsolve(const MAT *QR, const VEC *diag, PERM *pivot, const VEC *b,
               VEC *x);
...
extern MAT *_hhtrcols(MAT *, unsigned int, unsigned int, const VEC *, double,
                      VEC *);

extern void givens(double, double, Real *, Real *);
extern VEC *rot_vec(const VEC *, unsigned int, unsigned int, double, double,
                    VEC *); /* in situ */
extern MAT *rot_rows(const MAT *, unsigned int, unsigned int, double, double,
                     MAT *); /* in situ */
extern MAT *rot_cols(const MAT *, unsigned int, unsigned int, double, double,
                     MAT *); /* in situ */
