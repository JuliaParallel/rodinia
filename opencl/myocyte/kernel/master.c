...
void master(fp timeinst, fp *initvalu, fp *parameter, fp *finavalu, fp *com,
            ...
            long long *timecopyin, long long *timekernel,
    ...
    error = clEnqueueWriteBuffer(command_queue, d_params, 1, 0, d_params_mem,
    ...
    clSetKernelArg(kernel, 0, sizeof(int), (void *)&timeinst);
    clSetKernelArg(kernel, 1, sizeof(cl_mem), (void *)&d_initvalu);
    clSetKernelArg(kernel, 2, sizeof(cl_mem), (void *)&d_finavalu);
    clSetKernelArg(kernel, 3, sizeof(cl_mem), (void *)&d_params);
    clSetKernelArg(kernel, 4, sizeof(cl_mem), (void *)&d_com);
    ...
    // Wait for all operations to finish, much like synchronizing threads in
    // CUDA
    ...
    error = clEnqueueReadBuffer(command_queue, d_com, CL_TRUE, 0, d_com_mem,
                                com, 0, NULL, NULL);
    if (error != CL_SUCCESS)
        fatal_CL(error, __LINE__);
