...
#include "./../../heartwall.h" // needed for definition of fp
...
void read_parameters(char *filename, int *tSize, int *sSize, int *maxMove,
                     fp *alpha) {
...
void read_header(char *filename, int *size, int *size_2) {
...
void read_data(char *filename, int size, int *input_a, int *input_b, int size_2,
