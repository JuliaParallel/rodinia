...
#include "./heartwall.h" // (in the main program folder)	needed to recognized input parameters
...
int main(int argc, char *argv[]) {
    ...
    read_parameters("../../data/heartwall/input.txt", &common.tSize,
                    &common.sSize, &common.maxMove, &common.alpha);

    //====================================================================================================100
    //	READ SIZE OF INPUTS FROM FILE
    //====================================================================================================100

    read_header("../../data/heartwall/input.txt", &common.endoPoints,
                &common.epiPoints);
    ...
    read_data("../../data/heartwall/input.txt", common.endoPoints, endoRow,
              endoCol, common.epiPoints, epiRow, epiCol);
    ...
    kernel_gpu_opencl_wrapper(common, endoRow, endoCol, tEndoRowLoc,
                              tEndoColLoc, epiRow, epiCol, tEpiRowLoc,
                              tEpiColLoc, frames);
    ...
    //==================================================50
    if (getenv("OUTPUT")) {
        write_data("output.txt", common.no_frames, common.frames_processed,
