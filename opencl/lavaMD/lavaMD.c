...
int main(int argc, char *argv[]) {
            ...
            if (argc >= dim_cpu.cur_arg + 1) {
                ...
                if (isInteger(argv[dim_cpu.cur_arg + 1]) == 1) {
                    ...
                    if (dim_cpu.boxes1d_arg < 0) {
                        printf("ERROR: Wrong value to -boxes1d argument, "
                               "cannot be <=0\n");
                        return 0;
                    }
                ...
                // value is not a number
                    ...
                    printf(
                        "ERROR: Value to -boxes1d argument in not a number\n");
                    return 0;
                }
            }
            // value not provided
    ...
    kernel_gpu_opencl_wrapper(par_cpu, dim_cpu, box_cpu, rv_cpu, qv_cpu,
                              fv_cpu);
    ...
    // 1000000, (float) (time1-time0) / (float) (time7-time0) * 100);
    ...
    // 1000000, (float) (time3-time2) / (float) (time7-time0) * 100);
    // printf("%15.12f s, %15.12f % : dim_cpu\n", 							(float) (time4-time3) /
    // 1000000, (float) (time4-time3) / (float) (time7-time0) * 100);
