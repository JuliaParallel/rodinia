...
********************************/
double calcLikelihoodSum(__global unsigned char *I, __global int *ind,
...
param3 Nparticles
****************************/
double updateWeights(__global double *weights, __global double *likelihood,
                     int Nparticles) {
    int x;
    double sum = 0;
...
int findIndexBin(__global double *CDF, int beginIndex, int endIndex,
                 double value) {
...
* param8: Nparticles
*****************************/
__kernel void find_index_kernel(__global double *arrayX,
                                __global double *arrayY, __global double *CDF,
                                __global double *u, __global double *xj,
                                __global double *yj, __global double *weights,
                                int Nparticles) {
...
__kernel void normalize_weights_kernel(__global double *weights, int Nparticles,
                                       __global double *partial_sums,
                                       __global double *CDF, __global double *u,
                                       __global int *seed) {
    int i = get_global_id(0);
...
*****************************/
__kernel void
likelihood_kernel(__global double *arrayX, __global double *arrayY,
                  __global double *xj, __global double *yj,
                  __global double *CDF, __global int *ind, __global int *objxy,
                  __global double *likelihood, __global unsigned char *I,
                  __global double *u, __global double *weights,
                  const int Nparticles, const int countOnes, const int max_size,
                  int k, const int IszY, const int Nfr, __global int *seed,
                  __global double *partial_sums, __local double *buffer) {
