...
/**
* Generates a uniformly distributed number in the range of [0, 1) using the
* Linear Congruential Generator (LCG)
* @param seed The provided seed array.
* @param index The index within the seed array that will be modified by this
* function.
* @return A float in the range of [0,1). This float is based on the modified
* seed value at index in the seed array.
...
/**
* Generates a normally (Gaussian) distributed number using the Box-Muller
* transformation
* @param seed The provided seed array.
* @param index The index within the seed array that will be modified as a result
* of this function
* @return A float in the range of FLOAT_MIN to FLOAT_MAX. This float is based on
* the modified seed value at index in the seed array.
...
int main() {
    ...
    // make kernel calls etc; device functions can now use seed array to
    // generate normal and uniform random numbers
