...
__device__ void kernel_2(int timeinst, fp *initvalu, fp *params, fp *finavalu,
                         fp *com) {
    ...
    kernel_cam_2(timeinst, initvalu, finavalu, valu_offset_Dyad, params,
                 params_offset_Dyad, com, com_offset_Dyad, CaDyad);

    // specific
    CaSL = initvalu[36] *
           1e3; // from ECC model, *** Converting from [mM] to [uM] ***
    // cam function for Dyad
    kernel_cam_2(timeinst, initvalu, finavalu, valu_offset_SL, params,
                 params_offset_SL, com, com_offset_SL, CaSL);

    // specific
    CaCyt = initvalu[37] *
            1e3; // from ECC model, *** Converting from [mM] to [uM] ***
    // cam function for Dyad
    kernel_cam_2(timeinst, initvalu, finavalu, valu_offset_Cyt, params,
                 params_offset_Cyt, com, com_offset_Cyt, CaCyt);

    //====================================================================================================
    //		SEGMENT HAPPENING 2ND IN TIME: FINAL
    //====================================================================================================

    kernel_fin_2(timeinst, initvalu, finavalu, valu_offset_ecc,
                 valu_offset_Dyad, valu_offset_SL, valu_offset_Cyt, params,
                 com);
