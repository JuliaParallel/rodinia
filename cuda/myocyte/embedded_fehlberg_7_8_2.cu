...
// This file is the modified version of embedded fehlberg 7.8 solver obrained
// from (http://mymathlib.webtrellis.net/index.html)
...
__device__ void embedded_fehlberg_7_8_2(fp h,
                                        ...
                                        fp timeinst, fp *initvalu, fp *finavalu,
                                        fp *parameter,

                                        fp *error, fp *initvalu_temp,
                                        fp *finavalu_temp, fp *com) {
    ...
    for (j = 0; j < 13; j++) {
        ...
        //===================================================================================================
            ...
            for (i = 0; i < EQUATIONS; i++) {
                initvalu_temp[i] =
                    initvalu[i] + h2_7 * (finavalu_temp[0 * EQUATIONS + i]);
            }
        ...
        //===================================================================================================
            ...
            for (i = 0; i < EQUATIONS; i++) {
                initvalu_temp[i] = initvalu[i] +
                                   h * (b31 * finavalu_temp[0 * EQUATIONS + i] +
                                        b32 * finavalu_temp[1 * EQUATIONS + i]);
            }
        ...
        //===================================================================================================
            ...
            for (i = 0; i < EQUATIONS; i++) {
                initvalu_temp[i] = initvalu[i] +
                                   h * (b41 * finavalu_temp[0 * EQUATIONS + i] +
                                        b43 * finavalu_temp[2 * EQUATIONS + i]);
            }
        ...
        //===================================================================================================
            ...
            for (i = 0; i < EQUATIONS; i++) {
                initvalu_temp[i] = initvalu[i] +
                                   h * (b51 * finavalu_temp[0 * EQUATIONS + i] +
                                        b53 * finavalu_temp[2 * EQUATIONS + i] +
        ...
        //===================================================================================================
            ...
            for (i = 0; i < EQUATIONS; i++) {
                initvalu_temp[i] = initvalu[i] +
                                   h * (b61 * finavalu_temp[0 * EQUATIONS + i] +
                                        b64 * finavalu_temp[3 * EQUATIONS + i] +
        ...
        //===================================================================================================
            ...
            for (i = 0; i < EQUATIONS; i++) {
                initvalu_temp[i] = initvalu[i] +
                                   h * (b71 * finavalu_temp[0 * EQUATIONS + i] +
                                        b74 * finavalu_temp[3 * EQUATIONS + i] +
        ...
        //===================================================================================================
            ...
            for (i = 0; i < EQUATIONS; i++) {
                initvalu_temp[i] = initvalu[i] +
                                   h * (b81 * finavalu_temp[0 * EQUATIONS + i] +
                                        b85 * finavalu_temp[4 * EQUATIONS + i] +
        ...
        //===================================================================================================
            ...
            for (i = 0; i < EQUATIONS; i++) {
                initvalu_temp[i] = initvalu[i] +
                                   h * (b91 * finavalu_temp[0 * EQUATIONS + i] +
                                        b94 * finavalu_temp[3 * EQUATIONS + i] +
        ...
        //===================================================================================================
            ...
            for (i = 0; i < EQUATIONS; i++) {
                initvalu_temp[i] =
                    initvalu[i] +
                    h * (b10_1 * finavalu_temp[0 * EQUATIONS + i] +
        ...
        //===================================================================================================
            ...
            for (i = 0; i < EQUATIONS; i++) {
                initvalu_temp[i] =
                    initvalu[i] +
                    h * (b11_1 * finavalu_temp[0 * EQUATIONS + i] +
        ...
        //===================================================================================================
            ...
            for (i = 0; i < EQUATIONS; i++) {
                initvalu_temp[i] =
                    initvalu[i] +
                    h * (b12_1 * finavalu_temp[0 * EQUATIONS + i] +
        ...
        //===================================================================================================
            ...
            for (i = 0; i < EQUATIONS; i++) {
                initvalu_temp[i] =
                    initvalu[i] +
                    h * (b13_1 * finavalu_temp[0 * EQUATIONS + i] +
        ...
        kernel_2(timeinst_temp, initvalu_temp, parameter,
                 &finavalu_temp[j * EQUATIONS], com);
    }
    ...
    for (i = 0; i < EQUATIONS; i++) {
        finavalu[i] = initvalu[i] +
                      h * (c_1_11 * (finavalu_temp[0 * EQUATIONS + i] +
                                     finavalu_temp[10 * EQUATIONS + i]) +
                           c6 * finavalu_temp[5 * EQUATIONS + i] +
                           c_7_8 * (finavalu_temp[6 * EQUATIONS + i] +
                                    finavalu_temp[7 * EQUATIONS + i]) +
                           c_9_10 * (finavalu_temp[8 * EQUATIONS + i] +
                                     finavalu_temp[9 * EQUATIONS + i]));
    ...
    for (i = 0; i < EQUATIONS; i++) {
        error[i] = fabs(err_factor * (finavalu_temp[0 * EQUATIONS + i] +
                                      finavalu_temp[10 * EQUATIONS + i] -
                                      finavalu_temp[11 * EQUATIONS + i] -
                                      finavalu_temp[12 * EQUATIONS + i]));
        // printf("Error[%d] = %f\n", i, error[i]);
    }
}
