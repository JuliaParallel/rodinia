...
// ping-ponging
// Also avoids most bank conflicts using single-element offsets every NUM_BANKS
// elements.
//
...
// using
// single-element offsets every NUM_BANKS elements, plus additional
...
// is defined)
// Con: More instructions to compute bank-conflict-free shared memory
// addressing,
