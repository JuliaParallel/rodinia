...
inline void
LogStats2(const char *graph,    // Groups several functions into one graph. Only
                                // appears in the file name.
          const char *function, // Name of the particular function. Appears in
                                // file name and legend.
          ...
          unsigned int fId = 0, // Determines the order in which different
                                // functions are plotted to a common graph. Only
                                // appears in the file name.
