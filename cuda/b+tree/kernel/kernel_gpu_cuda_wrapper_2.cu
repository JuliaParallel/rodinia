...
void kernel_gpu_cuda_wrapper_2(knode *knodes, long knodes_elem, long knodes_mem,
    ...
    cudaMemcpy(offset_2D, offset_2, count * sizeof(long),
               cudaMemcpyHostToDevice);
    ...
    cudaMemcpy(ansDStart, recstart, count * sizeof(int),
               cudaMemcpyHostToDevice);
    ...
    findRangeK<<<numBlocks, threadsPerBlock>>>(maxheight, knodesD, knodes_elem,
                                               ...
                                               offset_2D, startD, endD,
                                               ansDStart, ansDLength);
    cudaThreadSynchronize();
    ...
    cudaMemcpy(recstart, ansDStart, count * sizeof(int),
